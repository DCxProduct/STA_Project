                    ...
                    @foreach(Helper::languagesList() as $ActiveLanguage)
                        @if($ActiveLanguage->box_status)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('details_'.@$ActiveLanguage->code,$Banners->{'details_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control', 'required'=>'', 'dir'=>@$ActiveLanguage->direction,'rows'=>'3')) !!}
                                </div>
                            </div>
                        @endif
                    @endforeach
                    ...
                    @foreach(Helper::languagesList() as $ActiveLanguage)
                        @if($ActiveLanguage->box_status)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('link_'.@$ActiveLanguage->code,$Banners->{'link_'.@$ActiveLanguage->code}, array('placeholder' => 'http://www.site.com','class' => 'form-control','required'=>'','maxlength'=>191, 'dir'=>'ltr')) !!}
                                </div>
                            </div>
                        @endif
                    @endforeach
