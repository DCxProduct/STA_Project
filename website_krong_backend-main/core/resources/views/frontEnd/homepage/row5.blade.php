...
$HomeTopics = Helper::Topics(Helper::GeneralWebmasterSettings("home_content7_section_id"), 0, $HomeTopicsLimit);
...
@if(count($HomeTopics)>0)
    <section class="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="owl-slider5" class="owl-carousel owl-theme listing">
                        <?php
                        $section_url = "";
                        ?>
