    ...
    public function list(Request $request)
    {
        ...
        if ($totalFiltered > 0) {
            foreach ($Tags as $Tag) {
                ...
                if (@Auth::user()->permissionsGroup->edit_status) {
                    $nestedData['title'] = '<a href="#" onclick="UpdateTag(\'' . $Tag->id . '\');return false;">' . "<div class='h6 m-b-0 line-height-30'>" . $Tag->title . "</div>" . '</a>';
                } else {
                    $nestedData['title'] = "<div class='h6 m-b-0 line-height-30'>" . $Tag->title . "</div>";
                }
