...
Route::middleware('api_key.check')->group(function () {
    ...
    Route::get('/projects/page/{topic_id}/{lang?}', 'HomeController@project');
    Route::get('/projects/category/{cat_id}/{page_number?}/{lang?}', 'HomeController@projects_category');
    Route::get('/projects/{page_number?}/{lang?}', 'HomeController@projects');

    Route::get('/sounds/page/{topic_id}/{lang?}', 'HomeController@sound');
    Route::get('/sounds/{page_number?}/{lang?}', 'HomeController@sounds');

    Route::get('/videos/page/{topic_id}/{lang?}', 'HomeController@video');
    Route::get('/videos/{page_number?}/{lang?}', 'HomeController@videos');

    Route::get('/opportunities/page/{topic_id}/{lang?}', 'HomeController@opportunity');
    Route::get('/opportunities/category/{cat_id}/{page_number?}/{lang?}', 'HomeController@opportunity_category');
    Route::get('/opportunities/{page_number?}/{lang?}', 'HomeController@opportunities');
    ...
    // get dashboard info
    Route::get('/dashboard/{topic_id}/{lang?}', 'HomeController@dashboard');
