...
<div class="tab-pane {{  ( Session::get('active_tab') == 'socialTab') ? 'active' : '' }}"
    ...
    <div class="p-a-md col-md-12">
        ...
        <div class="form-group">
            <label><i class="fab fa-youtube-play"></i> &nbsp; {!!  __('backend.youtube') !!}</label>
            {!! Form::text('social_link2',$Setting->social_link2, array('placeholder' => __('backend.youtube'),'class' => 'form-control', 'dir'=>'ltr')) !!}
        </div>

        <div class="form-group">
            <label><i class="fab fa-telegram"></i> &nbsp; {!!  __('backend.telegram') !!}</label>
            {!! Form::text('social_link3',$Setting->social_link3, array('placeholder' => __('backend.telegram'),'class' => 'form-control', 'dir'=>'ltr')) !!}
        </div>

        <div class="form-group">
            <label><i class="fab fa-x-twitter"></i> &nbsp; {!!  __('backend.x-twitter') !!}
            </label>
            {!! Form::text('social_link4',$Setting->social_link4, array('placeholder' => __('backend.x-twitter'),'class' => 'form-control', 'dir'=>'ltr')) !!}
        </div>

        <div class="form-group">
            <label><i class="fab fa-linkedin"></i> &nbsp; {!!  __('backend.linkedin') !!}</label>
            {!! Form::text('social_link5',$Setting->social_link5, array('placeholder' => __('backend.linkedin'),'class' => 'form-control', 'dir'=>'ltr')) !!}
        </div>
