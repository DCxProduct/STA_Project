...
$bool = true; 
$section_textrunning = config('dev.app.text_running_section');
$section_management  = config('dev.app.welcome_section');
$contact_page        = config('dev.app.contact_us_page');
$about_page          = config('dev.app.about_page');
if($Topic->webmasterSection->id == $section_textrunning || $Topic->webmasterSection->id == $section_management){
    $bool = false; 
}
?>
    ...
    <div class="padding">
                    ...
                    <li class="nav-item inline dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-scale pull-right">
                            ...
                            @if($bool)
                                ...
                                @endif
                                @if($Topic->id != $contact_page && $Topic->id != $about_page)
        ...
        <div class="box nav-active-border b-info">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <div class='input-group date' ui-jp="datetimepicker" ui-options="{
                                            ...
                                            {!! Form::text('date', $Topic->date ? \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $Topic->date)->format(config('smartend.date_format')) : \Carbon\Carbon::now()->format(config('smartend.date_format')), [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'id' => 'date',
                                                'required' => ''
                            ...
                            @foreach(Helper::languagesList() as $ActiveLanguage)
                                @if($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('title_'.@$ActiveLanguage->code,$Topic->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control line-height-30','required'=>'','maxlength'=>250, 'dir'=>@$ActiveLanguage->direction)) !!}
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                        ...
                        @if($WebmasterSection->photo_status)
                            <div class="form-group row">
                                <label for="photo_file"
                                       class="col-sm-2 form-control-label">{!!  __('backend.topicPhoto') !!} </label> <!--<span style="color:red;"> *</span>-->
                                <div class="col-sm-10">
                                    @if($Topic->photo_file!="")
                                        <div class="row">
                                            <div class="col-sm-12">
            ...
            locale:'{{ @Helper::currentLanguage()->code }}'
                                                        ...
                                                        {!! Form::text('customField_'.$customField->id,Helper::formatDate($cf_saved_val)." ".date("h:i", strtotime($cf_saved_val)), array('placeholder' => '','class' => 'form-control','id'=>'customField_'.$customField->id,$cf_required=>'', 'dir'=>$cf_land_dir)) !!}
                                                        <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
                                                    </div>
