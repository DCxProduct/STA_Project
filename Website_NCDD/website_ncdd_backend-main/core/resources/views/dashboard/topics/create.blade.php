                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <div class='input-group date' ui-jp="datetimepicker" ui-options="{
                                    ...
                                    {!! Form::text('date', Helper::formatDate(date("Y-m-d H:i:00")), [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'date',
                                        'required' => ''
            ...
            locale:'{{ @Helper::currentLanguage()->code }}'
                ...
                @if($WebmasterSection->sections_status!=0)
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="section_id[]" id="section_id" class="form-control select2-multiple line-height-30" multiple
                                    ui-jp="select2"
                        ...
                        @if($ActiveLanguage->box_status)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    {!! Form::text('title_'.@$ActiveLanguage->code,'', array('placeholder' => '','class' => 'form-control line-height-30','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @if (Helper::GeneralWebmasterSettings("text_editor") == 2)
                                            <div>
                                                {!! Form::textarea('details_'.@$ActiveLanguage->code,'<div dir='.@$ActiveLanguage->direction.'><br></div>', array('placeholder' => '','class' => 'form-control line-height-30 ckeditor', 'dir'=>@$ActiveLanguage->direction)) !!}
                                            </div>
                                        @elseif (Helper::GeneralWebmasterSettings("text_editor") == 1)
                                            <div>
                                                {!! Form::textarea('details_'.@$ActiveLanguage->code,'<div dir='.@$ActiveLanguage->direction.'><br></div>', array('placeholder' => '','class' => 'form-control line-height-30 tinymce', 'dir'=>@$ActiveLanguage->direction)) !!}
                                            </div>
                                        @else
                                            <div class="box p-a-xs">
                                            {!! Form::textarea('details_'.@$ActiveLanguage->code, '<div dir='.@$ActiveLanguage->direction.'><br></div>', 
                                                array(
                                                    'ui-jp' => 'summernote',
                                                    'placeholder' => '',
                                                    ...
                                                    'ui-options' => '{
                                                        ...
                                                        callbacks: {
                                                            onInit: function() {
                                                                $(".summernote_'.@$ActiveLanguage->code.'").summernote("fontName", "Hanuman");
                                                                $(".summernote_'.@$ActiveLanguage->code.'").summernote("fontSize", "14");
                                                            },
                ...
                @if($WebmasterSection->type==2)
                    ...
                    <div class="form-group row" id="youtube_link_div" style="display: block">
                ...
                @if($WebmasterSection->photo_status)
                    ...
                    <div class="form-group row">
                        <label for="photo_file" class="col-sm-2 form-control-label">
                            {!! __('backend.topicPhoto') !!} <!--<span style="color:red;"> *</span>-->
                        </label>
                        <div class="col-sm-10">
                            {!! Form::file('photo_file', ['class' => 'form-control', 'id' => 'photo_file', 'accept' => 'image/*']) !!}
                            {{-- {!! Form::file('photo_file', ['class' => 'form-control', 'id' => 'photo_file', 'accept' => 'image/*', 'required'=>'']) !!} --}}
                        </div>
                    </div>
                    <div class="form-group row m-t-md" style="margin-top: 0 !important;">
                        <div class="offset-sm-2 col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                {!! Form::text('icon','', array('autocomplete' => 'off','class' => 'form-control line-height-30 icp icp-auto','id'=>'icon', 'data-placement'=>'bottomRight')) !!}
