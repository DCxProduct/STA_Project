                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::text('seo_title_'.@$ActiveLanguage->code,$Topic->{'seo_title_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_title_'.@$ActiveLanguage->code,'maxlength'=>'295', 'dir'=>@$ActiveLanguage->direction)) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <div>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::textarea('seo_description_'.@$ActiveLanguage->code,$Topic->{'seo_description_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_description_'.@$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction,'rows'=>'2','maxlength'=>'250')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::textarea('seo_keywords_'.@$ActiveLanguage->code,$Topic->{'seo_keywords_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_keywords_'.@$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction,'rows'=>'2','maxlength'=>'250')) !!}
                                </div>
                            </div>
                            <br>
                            <br>
