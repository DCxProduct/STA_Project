                                    ...
                                    @foreach(Helper::languagesList() as $ActiveLanguage)
                                        @if($ActiveLanguage->box_status)
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    {!! Form::text('title_'.@$ActiveLanguage->code,$EditedMenu->{'title_'.@$ActiveLanguage->code}, array('placeholder' => $ActiveLanguage->title,'class' => 'form-control line-height-30','required'=>'','maxlength'=>250, 'dir'=>@$ActiveLanguage->direction)) !!}
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    @foreach(Helper::languagesList() as $ActiveLanguage)
                                        @if($ActiveLanguage->box_status)
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    {!! Form::text('title_'.@$ActiveLanguage->code,'', array('placeholder' =>$ActiveLanguage->title,'class' => 'form-control','required'=>'','maxlength'=>250, 'dir'=>@$ActiveLanguage->direction)) !!}
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
