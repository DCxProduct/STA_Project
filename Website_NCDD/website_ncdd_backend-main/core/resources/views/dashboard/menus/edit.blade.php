                    ...
                    @if($ActiveLanguage->box_status)
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                {!! Form::text('title_'.@$ActiveLanguage->code,$Menus->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control line-height-30','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
