...
$bool = true; 
$announcement_cat_id = 0;
$section_card = config('dev.app.card_section');
$announcement_cat      = config('dev.app.announcement');
if($WebmasterSection->id == $section_card){
    $bool = false; 
}
?>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown {{ (($x+1) >= count($Sections))?"dropup":"" }}">
                                            ...
                                            <div class="dropdown-menu pull-right">
                                                ...
                                                @if($bool)
                                                    @if($Section->id != $announcement_cat)
                                                    ...
                                                    @else
                                                        <?php
                                                            $announcement_cat_id = $Section->id;
                                                        ?>
                                                    @endif
                                                @endif
                                            </div>
                            ...
                            <div class="col-sm-3 hidden-xs">
                                ...
                                @if(@Auth::user()->permissionsGroup->edit_status)
                                    <select name="action" id="action" class="form-control c-select w-sm inline v-middle"
                                        ...
                                        @if($bool)
                                            @if($announcement_cat_id != $announcement_cat)
                                                @if(@Auth::user()->permissionsGroup->delete_status)
