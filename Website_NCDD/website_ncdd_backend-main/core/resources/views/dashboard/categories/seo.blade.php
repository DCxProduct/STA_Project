                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::textarea('seo_description_'.@$ActiveLanguage->code,$Sections->{'seo_description_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_description_'.@$ActiveLanguage->code,'maxlength'=>'250', 'dir'=>@$ActiveLanguage->direction,'rows'=>'2')) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <div>
