    ...
    <div class="left navside dark dk" layout="column">
        ...
        <div class="navbar navbar-md no-radius">
            ...
            <a class="navbar-brand" href="{{ route('adminHome') }}">
                ...
                ?>
                <img src="{{ URL::to('uploads/settings/'.Helper::GeneralSiteSettings('style_fav')) }}" alt="Control">
                <!-- <span class="hidden-folded inline">{{ __('backend.control') }}</span> -->
                <span class="hidden-folded inline">{{Helper::GeneralSiteSettings($site_title_var)}}</span>
            </a>
            <!-- / brand -->
        </div>
...
<i class="material-icons">&#xe2c7;</i>
                    ...
                    @if(Helper::GeneralWebmasterSettings("file_manager_status"))
                        @if(@Auth::user()->permissionsGroup->file_manager_status)
                            <?php
                            $currentFolder = "sso-keycloak"; // Put folder name here
                            $PathCurrentFolder = substr($urlAfterRoot, 0, strlen($currentFolder));
                            ?>
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a href="{{ route('FileManager') }}">
...
<i class="material-icons">repeat</i>
                                    ...
                                    <span class="nav-text">{{ __('backend.SSO') }}</span>
                                </a>
                            </li>
