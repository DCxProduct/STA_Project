                ...
                @foreach(Helper::languagesList() as $ActiveLanguage)
                    @if($ActiveLanguage->box_status)
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('title_'.@$ActiveLanguage->code,'', array('placeholder' => '','class' => 'form-control line-height-30','required'=>'','maxlength'=>250, 'dir'=>@$ActiveLanguage->direction)) !!}
                            </div>
                        </div>
                    @endif
                @endforeach
                    ...
                    @foreach(Helper::languagesList() as $ActiveLanguage)
                        @if($ActiveLanguage->box_status)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('link_'.@$ActiveLanguage->code,'', array('placeholder' => 'http://www.site.com','class' => 'form-control','maxlength'=>250, 'dir'=>'ltr')) !!}
                                </div>
                            </div>
                        @endif
                    @endforeach
