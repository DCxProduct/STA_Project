...
$HomeTopics = Helper::Topics(Helper::GeneralWebmasterSettings("home_content2_section_id"), 0, $HomeTopicsLimit);
...
@if(count($HomeTopics)>0)
    <section class="section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="owl-slider4" class="owl-carousel owl-theme listing">
                        <?php
                        $section_url = "";
                        ?>
