        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="bottom-article">
                    {{Form::open(['route'=>['commentSubmit'],'method'=>'POST','enctype' => 'multipart/form-data','class'=>'commentForm','id'=>'commentForm'])}}
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="comment_document" class="form-control-label">
                                {!! __('frontend.document') !!}
                            </label>
                            {!! Form::file('comment_document', ['class' => 'form-control', 'id' => 'comment_document', 'accept' => 'application/pdf', 'required' => '']) !!}
                        </div>
                    </div>
