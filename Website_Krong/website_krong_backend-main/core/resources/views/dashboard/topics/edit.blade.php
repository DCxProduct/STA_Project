                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @if($WebmasterSection->longtext_status)
                            ...
                            @if($WebmasterSection->editor_status)
                                ...
                                @foreach(Helper::languagesList() as $ActiveLanguage)
                                    @php
                                    $content = $Topic->{'details_' . @$ActiveLanguage->code};
                                    
                                    // Decode any HTML entities first to handle &quot; and others
                                    $content = html_entity_decode($content, ENT_QUOTES, 'UTF-8');

                                    // Now apply the regex to remove quotes in font-family
                                    $content = preg_replace('/font-family:\s*"([^"]+)"/', 'font-family: $1', $content);
                                    @endphp
                                    @if($ActiveLanguage->box_status)
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                ...
                                                <a class="btn btn-outline b-a m-y-sm  light dk w-full"
                                                   href="{{ route("builder",$Topic->id) }}?lang={{ @$ActiveLanguage->code }}"
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                @else
                                                    ...
                                                    {!! Form::textarea('details_'.@$ActiveLanguage->code,$content, 
                                                        array(
                                                            'ui-jp' => 'summernote',
                                                            'placeholder' => '',
                                                            ...
                                                            'ui-options' => '{
                                                                ...
                                                                fontNames: ["Arial", "Courier New", "Times New Roman", "Poppins", "Roboto", , "Hanuman","Moul"],
                                                                fontNamesIgnoreCheck: ["Poppins", "Roboto", "Hanuman", "Moul"],
                        ...
                        @if($WebmasterSection->photo_status)
                            <div class="form-group row">
                                <label for="photo_file"
                                       class="col-sm-2 form-control-label">{!!  __('backend.topicPhoto') !!} <span style="color:red;"> *</span></label>
                                <div class="col-sm-10">
                                    @if($Topic->photo_file!="")
                                        <div class="row">
                                            <div class="col-sm-12">
                                    ...
                                    @else
                                        {!! Form::file('photo_file', array('class' => 'form-control','id'=>'photo_file','accept'=>'image/*','required'=>'')) !!}                 
                                    @endif
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    {!! Form::hidden($file_old_id,$cf_saved_val, array('id'=>$file_old_id)) !!}
                                                @endif
                                                {!! Form::file('customField_'.$customField->id, array('class' => 'form-control','id'=>'customField_'.$customField->id,'accept'=>'.pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt')) !!}
                                            </div>
                                        </div>
