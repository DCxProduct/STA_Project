...
@endpush
@section('content')
    <div class="padding p-b-0 alert-copy" style="display:none;">
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                ...
                $section_sitepage    = 1;
                if($WebmasterSection->id == $section_feedback || $WebmasterSection->id == $section_welcome){
                    $bool = false; 
                }
                ?>
                        ...
                        @if(@Auth::user()->permissionsGroup->delete_status)
                            ...
                            @if(@Auth::user()->permissionsGroup->edit_status)
                                <select name="action" id="action"
                                    ...
                                    @if($bool)
                                        @if($WebmasterSection->id != $section_sitepage)
                                            @if(@Auth::user()->permissionsGroup->delete_status)
