...
const MobileMenuSearch = () => {
  return (
    <div className="pb-10 border-b border-borderColor dark:border-borderColor-dark">
      <form className="flex justify-between items-center w-full bg-whitegrey2 dark:bg-whitegrey2-dark px-15px py-[11px] rounded-md">
        <input
          type="text"
        ...
        />
        <button className="block text-lg text-darkdeep1 hover:text-blueDefault">
